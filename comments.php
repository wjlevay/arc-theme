...
<?php if ( have_comments() ) : ?>
	<h3 id="comments" class="h3"><?php comments_number( __( '<span>no</span> comments ', 'bonestheme' ), __( '<span>1</span> comment ', 'bonestheme' ), _n( '<span>%</span> comments ', '<span>%</span> comments ', get_comments_number(), 'bonestheme' ) );?></h3>
	<section id="comment-wrap"><?php // Added this div to allow the show/hide comments js to have something to hang onto ?>
	
		<?php // Uncomment if you want comment section nav
		/* <nav id="comment-nav">
			<ul class="clearfix">
...
<?php if ( comments_open() ) : ?>
	...
	<section id="respond" class="respond-form">
		...
		<h3 id="comment-form-title" class="h3"><?php comment_form_title( __( 'leave a comment', 'bonestheme' ), __( 'leave a comment on %s', 'bonestheme' )); ?></h3>
		...
		<?php // Uncomment this section if you want to show allowed HTML tags
